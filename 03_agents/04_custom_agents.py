...
def _(mo):
    mo.md(
        ...
        - any class that inherits from `google.adk.agents.BaseAgent`
        - implements `_run_async_impl`
...
def _():
    ...
    GEMINI_2_FLASH = LiteLlm(model="openai/llama3.2")
    ...
    class StoryFlowAgent(BaseAgent):
        ...
        async def _run_async_impl(
            ...
            if tone_check_result == "negative":
                ...
                logger.info(
                    f"[{self.name}] Tone is not negative. Keeping current story."
                )
                pass
